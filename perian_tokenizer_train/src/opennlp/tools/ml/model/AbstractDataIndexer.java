...
public abstract class AbstractDataIndexer implements DataIndexer {
  ...
  protected int sortAndMerge(List<ComparableEvent> eventsToCompare, boolean sort)
    ...
    if (sort && eventsToCompare.size() > 0) {
      ...
      System.out.println("sorting event Collection is done.");
      System.out.println("counting and removing event duplicates... ");
      ...
      for (int i = 1; i < numEvents; i++) {
        ...
        if(eventCount % 100000 == 0){
        	double progress = eventCount/ numEvents * 100;
    ...
    eventCount = 0;
    System.out.println("last step of indexing... ");
